...
BinFeedingData.Licks.SaveResults(dfm11, bindfm11, "M11_13Jun2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm12, bindfm12, "M12_13Jun2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm13, bindfm13, "M13_13Jun2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm14, bindfm14, "M14_09Sep_test.xlsx", binInterval)
#-------Save to Excel----------
