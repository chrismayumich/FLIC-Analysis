...
maxes_N <- findMaximas(makeDeadNA(all_N, sucrose=20, pathway="UAS-NaChBac/+"))
maxes_64fN <- findMaximas(makeDeadNA(all_64fN, sucrose=20, "Gr64f>NaChBac"))
...
write.csv(maxes_N$DinnerMaxTimes, "dinner_N_maxtimes.csv")
write.csv(maxes_64fN$DinnerMaxTimes, "dinner_64fN_maxtimes.csv")
write.csv(maxes_64f$BreakfastMaxTimes, "breakfast_64f_maxtimes.csv")
write.csv(maxes_N$BreakfastMaxTimes, "breakfast_N_maxtimes.csv")
write.csv(maxes_64fN$BreakfastMaxTimes, "breakfast_64fN_maxtimes.csv")
...
end_breakfast_N <- findMinimas(maxes_N$BreakfastMaxIndices, maxes_N$df1)
end_breakfast_64fN <- findMinimas(maxes_64fN$BreakfastMaxIndices, maxes_64fN$df1)
end_dinner_64f <- findDinnerEnd(maxes_64f$DinnerMaxIndices, maxes_64f$df1)
end_dinner_N <- findDinnerEnd(maxes_N$DinnerMaxIndices, maxes_N$df1)
end_dinner_64fN <- findDinnerEnd(maxes_64fN$DinnerMaxIndices, maxes_64fN$df1)
...
write.table(end_breakfast_N, "breakfast_N_end.csv", sep=",", row.names = paste("Day", c(1:nrow(end_breakfast_N))), col.names=paste("Fly",c(1:ncol(end_breakfast_N))))
write.table(end_dinner_N, "dinner_N_end.csv", sep=",", row.names = paste("Day", c(1:nrow(end_dinner_N))), col.names=paste("Fly",c(1:ncol(end_dinner_N))))
write.table(end_breakfast_64fN, "breakfast_64fN_end.csv", sep=",", row.names = paste("Day", c(1:nrow(end_breakfast_64fN))), col.names=paste("Fly",c(1:ncol(end_breakfast_64fN))))
write.table(end_dinner_64fN, "dinner_64fN_end.csv", sep=",", row.names = paste("Day", c(1:nrow(end_dinner_64fN))), col.names=paste("Fly",c(1:ncol(end_dinner_64fN))))
...
start_breakfast_N <- findBreakfastStart(maxes_N$BreakfastMaxIndices, maxes_N$df1)
start_breakfast_64fN <- findBreakfastStart(maxes_64fN$BreakfastMaxIndices, maxes_64fN$df1)
start_dinner_64f <- findMinimasBefore(maxes_64f$DinnerMaxIndices, maxes_64f$df1)
start_dinner_N <- findMinimasBefore(maxes_N$DinnerMaxIndices, maxes_N$df1)
start_dinner_64fN <- findMinimasBefore(maxes_64fN$DinnerMaxIndices, maxes_64fN$df1)
...
write.table(start_breakfast_N, "breakfast_N_start.csv", sep=",", row.names = paste("Day", c(1:nrow(start_breakfast_N))), col.names=paste("Fly",c(1:ncol(start_breakfast_N))))
write.table(start_dinner_N, "dinner_N_start.csv", sep=",", row.names = paste("Day", c(1:nrow(start_dinner_N))), col.names=paste("Fly",c(1:ncol(start_dinner_N))))
write.table(start_breakfast_64fN, "breakfast_64fN_start.csv", sep=",", row.names = paste("Day", c(1:nrow(start_breakfast_64fN))), col.names=paste("Fly",c(1:ncol(start_breakfast_64fN))))
write.table(start_dinner_64fN, "dinner_64fN_start.csv", sep=",", row.names = paste("Day", c(1:nrow(start_dinner_64fN))), col.names=paste("Fly",c(1:ncol(start_dinner_64fN))))
