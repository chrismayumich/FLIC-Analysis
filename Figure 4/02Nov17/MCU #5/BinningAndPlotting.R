...
BinFeedingData.Licks.SaveResults(dfm9, bindfm9, "M09_02Nov2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm7, bindfm7, "M07_02Nov2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm8, bindfm8, "M08_02Nov2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm11, bindfm11, "M11_02Nov2017.xlsx", binInterval)
#-------Save to Excel----------
