...
BinFeedingData.Licks.SaveResults(dfm2, bindfm2, "M02_02Nov2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm3, bindfm3, "M03_02Nov2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm6, bindfm6, "M06_02Nov2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm5, bindfm5, "M05_02Nov2017.xlsx", binInterval)
#-------Save to Excel----------
...
write.xlsx(binevents2,"Ev02_30Jun_30m.xlsx")

binevents3<-BinFeedingData.Events(dfm3,binInterval)
write.xlsx(binevents3,"Ev03_30Jun_30m.xlsx")

binevents4<-BinFeedingData.Events(dfm4,binInterval)
write.xlsx(binevents4,"Ev04_30Jun_30m.xlsx")

binevents5<-BinFeedingData.Events(dfm5,binInterval)
write.xlsx(binevents5,"Ev05_30Jun_30m.xlsx")
#------------Events------------