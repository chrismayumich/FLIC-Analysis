...
BinFeedingData.Licks.SaveResults(dfm17, bindfm17, "M17_20Jun2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm18, bindfm18, "M18_20Jun2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm19, bindfm19, "M19_20Jun2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm20, bindfm20, "M20_20Jun2017.xlsx", binInterval)
#-------Save to Excel----------
