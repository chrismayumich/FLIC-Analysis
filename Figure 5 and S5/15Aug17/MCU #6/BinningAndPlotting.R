...
BinFeedingData.Licks.SaveResults(dfm12, bindfm12, "M12_15Aug2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm13, bindfm13, "M13_15Aug2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm14, bindfm14, "M14_15Aug2017.xlsx", binInterval)

BinFeedingData.Licks.SaveResults(dfm15, bindfm15, "M15_15Aug2017.xlsx", binInterval)
#-------Save to Excel----------
